# Метод __del__()
"""
Перед уничтожением экземпляра автоматически вызывается метод, называемый деструктором. Метод __del__()
Деструктор не будет вызван, если на экземпляр класса есть сслыка.
"""
